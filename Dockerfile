...
RUN wget -O pb-server/run/client/mods/hmc-specifics-1.21.1.jar \
    https://github.com/3arthqu4ke/hmc-specifics/releases/download/v1.21.1-2.2.1/hmc-specifics-fabric-1.20.4-1.8.1.jar

RUN wget -O pb-server/run/client/mods/hmc-optimizations-0.4.0-fabric.jar \
    https://github.com/3arthqu4ke/hmc-optimizations/releases/download/latest/hmc-optimizations-0.4.0-fabric.jar
